 ...
 */
final class Version20210122232557 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, journalist_id_id INT DEFAULT NULL, genre_id_id INT DEFAULT NULL, publication_date DATE NOT NULL, INDEX IDX_23A0E6696FF7AAB (journalist_id_id), INDEX IDX_23A0E66C2428192 (genre_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
