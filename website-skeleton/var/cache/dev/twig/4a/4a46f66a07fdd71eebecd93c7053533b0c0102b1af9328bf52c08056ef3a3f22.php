...
class __TwigTemplate_ec8b4725f6e318a76eaf2e2360a548201b25ffb748145efc4983482ed2d5e0df extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <?php echo \$view['form']->widget(\$form) ?>
<?php echo \$view['form']->end(\$form) ?>
", "@Framework/Form/form.html.php", "/Applications/MAMP/htdocs/workspace/web-Project/website-skeleton/vendor/symfony/framework-bundle/Resources/views/Form/form.html.php");
    }
}
