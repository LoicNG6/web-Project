 ...
 */
final class Version20210321122421 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, genre_id_id INT DEFAULT NULL, journalist_id INT NOT NULL, publication_date DATE NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, emergency TINYINT(1) NOT NULL, INDEX IDX_23A0E66C2428192 (genre_id_id), INDEX IDX_23A0E6634F59171 (journalist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
